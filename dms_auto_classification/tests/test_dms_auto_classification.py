...
class TestDmsAutoClassification(common.TransactionCase):
    ...
    def test_wizard_dms_clasification_process(self):
        ...
        self.wizard.action_classify()
        self.assertEqual(self.wizard.state, "classified")
        ...
        self.extra_wizard.action_classify()
        self.assertEqual(self.extra_wizard.state, "classified")
